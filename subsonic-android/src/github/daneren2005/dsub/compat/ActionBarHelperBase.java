...
package github.daneren2005.dsub.compat;
...
import github.daneren2005.dsub.util.SimpleMenu;
import github.daneren2005.dsub.util.SimpleMenuItem;
...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, android.R.id.home, 0, mActivity.getString(R.string.common_appname));
        homeItem.setIcon(R.drawable.main_header_icon2);
                    ...
                    switch (eventType) {
                        case XmlPullParser.START_TAG:
                            ...
                            showAsAction = parser.getAttributeIntValue(MENU_RES_NAMESPACE,
                                    MENU_ATTR_SHOW_AS_ACTION, 0);
                            int actionMaskedAlways = showAsAction & MenuItem.SHOW_AS_ACTION_IF_ROOM;
                            if ((showAsAction & MenuItem.SHOW_AS_ACTION_ALWAYS) == MenuItem.SHOW_AS_ACTION_ALWAYS ||
                                    (showAsAction & MenuItem.SHOW_AS_ACTION_IF_ROOM) == MenuItem.SHOW_AS_ACTION_IF_ROOM) {
